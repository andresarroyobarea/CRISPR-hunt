...
rule alignment:
    ...
    output:
        count_table="results/alignment/{norm_state}.counts.txt",
        count_summary="results/alignment/{norm_state}.countsummary.txt",
    conda:
        config["conda_envs"]["mageck"]
    params:
        library_file=config["library_file"],
        norm_method=config["parameters"]["alignment"]["norm_method"],
        out_prefix=config["parameters"]["alignment"]["out_prefix"],
