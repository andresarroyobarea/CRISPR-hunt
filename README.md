...
- Supports **CRISPR KO**, **CRISPRa**, and **CRISPRi** screening data
- Modular design for flexible customization
- Automated **quality control (QC)** and **data normalization**
- Integration with leading tools such as `MAGeCK`, `BAGEL2`, `CRISPRcleanR`, and others 
- Downstream analysis including:
  - Hit ranking and enrichment
  - Pathway analysis
